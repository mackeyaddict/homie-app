  ...
  return (
    <section>
      <div className="bg-white py-14">
        <div className="container mx-auto h-screen flex flex-col justify-center items-center gap-9 md:rounded-s-[200px] md:rounded-e-[200px] lg:rounded-s-[400px] lg:rounded-e-[400px]">
