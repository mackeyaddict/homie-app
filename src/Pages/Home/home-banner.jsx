...
export default function HomeBanner() {
  return (
    <section>
      <div className="bg-gradient-to-t from-black to-white h-screen flex justify-center">
        <div className="container mx-auto px-4 grid grid-cols-1 place-items-center md:grid-cols-2 py-14">
